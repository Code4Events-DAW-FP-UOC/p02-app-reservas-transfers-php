...
<div class="container mt-4">
    <div class="btn-group mb-3">
        ...
        <a href="/userAdmin/calendarioSemana" class="btn btn-outline-primary active">Semana</a>
        <a href="/userAdmin/calendarioDia" class="btn btn-outline-primary">Día</a>
    </div>

    <h2 class="mb-4">Calendario de reservas - Vista semanal</h2>
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <?php if (empty($reservas)): ?>
                <tr>
                    <td colspan="7" class="text-center">No hay reservas para esta semana.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
