...
<head>
    <meta charset="UTF-8">
    <title>Admin - Isla Transfers</title>
    ...
    <style>
        ...
        .header { display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #007bff; padding-bottom: 1rem; margin-bottom: 2rem;}
        .role-badge { background: #007bff; color: white; padding: 5px 10px; border-radius: 5px; font-weight: bold; }
        ...
        .menu-item:hover { background: #007bff; color: white; transform: translateY(-3px); }
    </style>
</head>
<body>
    <div class="dashboard-container">
        ...
        <div class="menu-grid">
            <a href="/admin/reserva/nueva" class="menu-item">➕ Nueva Reserva</a>
            <a href="/admin/calendario" class="menu-item">📅 Calendario</a>
            <a href="/admin/reservas" class="menu-item">📋 Listado Reservas</a>
            <a href="/perfil" class="menu-item">👤 Mi Perfil</a>
        </div>
    </div>
</body>
</html>